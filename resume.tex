...
\begin{center}
    ...
    \begin{multicols}{2}
        ...
        \href{tel:+923095544409}{+92 309 5544409} \\
        \end{flushleft}
        
        \begin{flushright}
        % this could be LinkedIn, GitHub, or a personal website or social media account (if used for professional purposes)
        \large{Github}: \href{https://github.com/abdul-510}{\underline{abdul-510}} \\
        \large{LinkedIn}: \href{https://www.linkedin.com/in/abdulqadirarshad}{\underline{abdulqadirarshad}} \\
        \large{Webiste}: \href{https://abdulqadir.me}{\underline{abdulqadir.me}} \\
        % please ensure your email address is one you check
        \large{Email}: \href{mailto:bitf20m510@gmail.com}{bitf20m510@gmail.com}
        \end{flushright}
    \end{multicols}
\end{center}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        {PUCIT - University of the Punjab}{September, 2020 -- Present}
        {Bachelor of Science - Information Technology}{Lahore, Punjab, Pakistan}
        \resumeItemListStart
            \resumeItem{Expected graduation: July 2024}
            \resumeItem{GPA: 3.20/4.0}
        \resumeItemListEnd

    \resumeSubheading
        {Govt. Degree College, Sharaqpur Sharif}{2017 - 2020}
        {Intermediate in Engineering}{Sharaqpur Sharif, Punjab, Pakistan}
        \vspace*{1pt}
        \resumeItemListStart
            \resumeItem{Graduated with A+ grade.}
        \resumeItemListEnd    
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        {Teaching Assistant (Data Structures \& Algorithms)}{June, 2023 -- Present}
    ...
    \resumeSubheading
        {Teaching Assistant (Object Oriented Programming)}{February, 2023 -- June, 2023}
        {PUCIT - University of the Punjab}{Lahore, Punjab, Pakistan}
        \resumeItemListStart
            \resumeItem{Assisted students in the lab + other TA responsibilities}
          \resumeItemListEnd
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
        {Class Ambassador}{PUCIT - University of the Punjab}
        {Google Developer Student Clubs}{2022 -- 2023}
        \resumeItemListStart
            \small\resumeItem{Faculty Contact: Assist. Prof. Abdul Mateen}
            \resumeItem{Organized tech workshops and seminars}
            \resumeItem{E.g. CodeFest, Hacktoberfest, AppFest, CodeBees, PUCON etc}
        \resumeItemListEnd    
